  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="<%=path %>/admin/list_user.action" target="main">会员信息</a></li>
          <li><a href="email_setting.jsp" target="main">邮件设置</a></li>
          <li><a href="reset_password.jsp" target="main">会员密码重设</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="search_order.jsp" target="main">订单查询</a></li>
